...
func (m *Miner) GetHashboards() ([]BoardData, error) {
	var v []BoardData
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_hashboards_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetHashboardsNoChips() ([]BoardData, error) {
	var v []BoardData
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_hashboards_no_chips_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetHashrate() (*HashRate, error) {
	var v *HashRate
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_hashrate_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetExpectedHashrate() (*HashRate, error) {
	var v *HashRate
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_expected_hashrate_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetFans() ([]FanData, error) {
	var v []FanData
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_fans_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetPSUFans() ([]FanData, error) {
	var v []FanData
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_psu_fans_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetFluidTemperature() (*float64, error) {
	var v *float64
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_fluid_temperature_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetOutletFluidTemperature() (*float64, error) {
	var v *float64
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_outlet_fluid_temperature_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetWattage() (*float64, error) {
	var v *float64
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_wattage_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetBestShare() (*float64, error) {
	var v *float64
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_best_share_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetSessionBestShare() (*float64, error) {
	var v *float64
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_session_best_share_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetTuningPercent() (*uint8, error) {
	var v *uint8
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_tuning_percent_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetTuningTarget() (*TuningTarget, error) {
	var v *TuningTarget
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_tuning_target_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetScaledTuningTarget() (*TuningTarget, error) {
	var v *TuningTarget
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_scaled_tuning_target_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetLightFlashing() (*bool, error) {
	var v *bool
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_light_flashing_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetMessages() ([]MinerMessage, error) {
	var v []MinerMessage
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_messages_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetIsMining() (bool, error) {
	var v bool
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_is_mining_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetOperatingState() (*OperatingState, error) {
	...
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_operating_state_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetPools() ([]PoolGroupData, error) {
	var v []PoolGroupData
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_pools_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetPoolsConfig() ([]PoolGroupConfig, error) {
	...
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_pools_config_json(ptr) }, &v)
	return v, err
}
...
func (m *Miner) GetPresets() ([]PresetInfo, error) {
	var v []PresetInfo
	err := m.getJSON(func(ptr *C.AsicMiner) *C.char { return C.asic_rs_miner_get_presets_json(ptr) }, &v)
	return v, err
}
