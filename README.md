...
|-------|----|------|--|
|Discovery and miner construction|[`MinerFactory`][__link0]|`pyasic_rs.MinerFactory`|`asic_go.MinerFactory`|
...
not wrapped yet; use `Scan()` and `GetMiner`.
 ...
 [__link0]: https://docs.rs/asic-rs/latest/asic_rs/struct.MinerFactory.html
